/*
Modified "dbo.Check_OpenTransactions.sql" to run as a script
https://github.com/amtwo/dba-database/blob/production/stored-procedures/dbo.Check_OpenTransactions.sql
*/
...
DECLARE	@DurationThreshold smallint = 1,

...
FROM    sys.dm_sql_referenced_entities('schema.referencing_entity_name', 'OBJECT') e
...
SELECT  e.referencing_schema_name AS objschema
       ...
       ,o.type_desc               AS objtype
FROM    sys.dm_sql_referencing_entities('schema.referenced_entity_name', 'OBJECT') e
        LEFT OUTER JOIN sys.objects                                          o

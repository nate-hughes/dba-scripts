...
USE rp_util -- Specify the database in which the objects will be created.
...
SET @BackupDirectory     = N'I:\SQL_Bak' -- Specify the backup root directory.
SET @CleanupTime         = 22         -- Time in hours, after which backup files are deleted. If no time is specified, then no backup files are deleted.
